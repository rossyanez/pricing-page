...
function PricingSection() {
  return (
    <div className="md:flex md:pb-24 md:flex-col md:items-center md:gap-16 md:self-stretch">
      <div className="flex items-center md:items-start md:gap-8 flex-col gap-y-4 md:flex-row md:gap-y-8 flex-1 my-auto md:justify-center md:w-[1280px] md:h-[510px] px-8">
        {/* single card */}
